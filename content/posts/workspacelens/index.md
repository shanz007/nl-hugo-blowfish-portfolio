...
draft: false
summary: "**WorkspaceLens** is a AI-powered mobile-first Progressive Web Application (PWA) that implements the **pOKW2 photo analysis model** (Herneoja et al., 2023) for collecting and analysing self-reported photographs from outdoor and semi-outdoor knowledge work environments."
showHero: true
---
...
👉 [Read More](/projects/academic/workspacelens/)