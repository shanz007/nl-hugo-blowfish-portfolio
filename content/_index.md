...
<ol style="list-style:none; padding-left: 0; margin: 0;">
  ...
  <li><strong><a href="https://shanz007.github.io/projects/academic/smartadaptiveinterfaces/">🔹 SmartAdaptiveInterfaces</a></strong> : LLM-powered browser extension for digital wellbeing <a href="https://dl.acm.org/doi/10.1145/3757980.3762111">Published at ACM MindTrek 2025</a> </li>
  <li><strong><a href="https://shanz007.github.io/projects/academic/trustifyai/">🔹 TrustifyAI</a></strong> : AI-driven tool for enhancing social media credibility (Master's Thesis)</li>
  <li><strong><a href="https://icta.lk/projects/digital-government/sludi">🔹 SLUDI</a></strong> : Sri Lanka's national digital identity framework (Tech Lead @ ICTA)</li>
</ul>
</div>
...
<ul class="not-prose space-y-1 list-none pl-0">
  ...
  <li>🔹<strong>Cloud & DevOps:</strong> AWS, GCP, Azure, Docker, Kubernetes, Jenkins, SonarQube, GitHub Actions, Terraform, Ansible, CI/CD</li><br>
  <li>🔹<strong>Middleware & Integration:</strong> WSO2 (Identity, API Manager, ESB), Kafka, RabbitMQ, RESTful APIs, GraphQL, gRPC</li><br>
  <li>🔹<strong>Databases:</strong> PostgreSQL, MySQL, Oracle, MongoDB, Redis, DynamoDB, Supabase</li><br>
  <li>🔹<strong>Practices:</strong> Agile, Scrum, SAFe, TDD, BDD, Microservices, Domain-Driven Design, CI/CD, DevOps</li><br>
</ul>
</div>
...
{{< alert icon="fire" >}}
**Research Profiles:** [ACM](https://dl.acm.org/doi/10.1145/3757980.3762111) • [ResearchGate](https://www.researchgate.net/profile/Niranjan-Liyanage) • [Google Scholar](https://scholar.google.com/citations?user=k3FTL4MAAAAJ&hl=en) • [ORCID](https://orcid.org/0009-0008-9110-6738)
{{< /alert >}}
</div>
...
<ul style="list-style: none; padding-left: 0; margin: 0;">
  ...
  <li>🔹<strong>B.Sc. (Hons) Information Technology</strong> : SLIIT, Sri Lanka</li>
  <li>🔹<strong>B.Sc. Information Technology</strong> : Curtin University, Australia</li>
</ul>
</div>
...
Interested in collaboration, consulting, or just want to chat about tech?

[About Me](/about/) • [Projects](/projects/) • [Resume](/resume/)

---

<p style="text-align:center; font-size:1.1em; font-weight:600; font-style:italic; border-top: 2px solid #6B7280; padding-top:16px; margin-top:8px;">
🌟 Building technology that's scalable, trustworthy, and human-centered.
</p>